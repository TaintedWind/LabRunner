...
public class MeleeEnemy extends Enemy {
    ...
    public MeleeEnemy(String n, double x, double y) {
        ...
        this.attackTimer = new Timer(1000, true, true);
    ...
    public void update() {
        ...
        if (facingDir == "left") {
            lineofsight.setBounds((int) ObjectList.player.X + 10, (int) Y, (int)X - (int) ObjectList.player.X + 10, H - 5);
        ...
        if ((ObjectList.player.hitbox.intersects(range) || state == "hostile") && getCollidingPlatform(lineofsight) == null) {
            followPlayer();
            if (attackTimer.getTime() >= 1000 && ObjectList.player.hitbox.intersects(hitbox)) {
